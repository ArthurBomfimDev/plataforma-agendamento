...
6. `Objetivo` - 9 edges
7. `ADR-007 — Monólito modular com fronteira de módulo verificada pelo build` - 9 edges
8. `Decisão` - 9 edges
9. `Booking.ArchitectureTests` - 8 edges
10. `ForbiddenDependencyTests` - 8 edges
...
Cohesion: 0.10
Nodes (15): ADR-010 — Organização do backend: camadas físicas, módulos por namespace e regras verificadas no CI, Como saber que erramos, Consequências, O que fica mais difícil, O que fica mais fácil, O que passa a ser proibido, Premissa não verificada, Problema (+7 more)

### Community 3 - "ReflectionRules"
Cohesion: 0.13
Nodes (13): BaseUsageTests, Fact, Fact, PaginationTests, Fact, Fact, ReflectionRules, Assembly (+5 more)
...
### Community 7 - "ReflectionRules.cs"
Cohesion: 0.06
Nodes (24): AssemblyReference, Assembly, AssemblyReference, Assembly, AssemblyReference, Assembly, AssemblyReference, Assembly (+16 more)
...
### Community 15 - "ADR-006 — Slot é resultado de cálculo, não linha de tabela"
Cohesion: 0.13
...
### Community 21 - "Booking.ArchitectureTests.Rules"
Cohesion: 0.08
Nodes (24): ForbiddenDependencyTests, TheoryData, IdentifierTests, ModuleBoundaryTests, TheoryData, PersistenceMappingTests, PackageRules, IReadOnlyList (+16 more)
...
Cohesion: 0.12
Nodes (13): Fact, MemberData, Theory, LayerDependencyTests, Fact, Fact, MemberData, Theory (+5 more)
...
## Knowledge Gaps
- **239 isolated node(s):** `Booking.Application`, `Assembly`, `Microsoft.NET.Sdk`, `Booking.Arguments`, `Assembly` (+234 more)
...
- **Why does `ADR-010 — Organização do backend: camadas físicas, módulos por namespace e regras verificadas no CI` connect `decisions/README.md` to `IBaseRepository`, `Booking.ArchitectureTests.Rules`?**
  _High betweenness centrality (0.268) - this node is a cross-community bridge._
- **Why does `5. Convenções de código` connect `IBaseRepository` to `CLAUDE.md`?**
  _High betweenness centrality (0.197) - this node is a cross-community bridge._
- **What connects `Booking.Application`, `Assembly`, `Microsoft.NET.Sdk` to the rest of the system?**
